...
Developing Copilot Agents with SAP datadepends very much on the infrastructure, architecture and components that are available in your landscape today. This page provides an overview on 
...
- Are you running your SAP system on Azure including RISE? Do you have a good Azure practice in-house? [Leveraging Azure API Management and vnet Peering (e.g. SAP S/4HANA Private Cloud or Native)](Architecture-APIM+vnet.md)
